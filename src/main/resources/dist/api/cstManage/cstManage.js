...
export const cstManage = {
  ...
  updateCstMntInfTbl: '/icst/myCustomer/updateCstMntInfTbl', //  更新客户维护信息
  findobnkAstSttnById: '/icst/myCustomer/findobnkAstSttnById/', // 获取客户维护信息
  ...
  //  ------------ 客户视图->客户互动 ------------
  findMyCstVstInf: '/icst/cstvstaction/findMyCstVstInf', // 客户互动
  //  ------------ 客户查询 ------------
  ...
  userAndCusterRelation: '/icst/customerQuery/userAndCusterRelation', // 登入用户与客户的关系
  //  ------------ 管辖查询 ------------
  findJurisdictionList: '/icst/jurisdictionQuery/findParmListCRM', // 管辖查询客户信息列表
  //  ------------ 客户调配 ------------
  ...
  // 客户分析图表
  getRetCusDataOne: '/icst/customerPortrait/assetDistribution', // 资产分布图 crm
  getRetCusDataTwo: '/icst/customerPortrait/assetDistribution', // 负债分布图 crm
  getRetCusDataThree: '/icst/customerPortrait/assetDistribution', // 客户利润分布   //
  getRetCusDataFour: '/icst/customerPortrait/depositBusiness', // 客户存款趋势图 crm
  getRetCusDataFive: '/icst/customerPortrait/depositBusiness', // 客户贷款趋势图 crm
  ...
  //  客户画像
  updateCstOtherInf: '/icst/myCustomer/updateCstMntInfTbl',
  // 合并后的
  addContactor: '/icstp/publiccustomers/addContactor', // 客户信息-联系人联系信息-新增或修改联系人联系信息
  getPublicCustomerPage: '/icst/public/getPublicCustomerPage', // 我的客户展示列表
  findBeIPBadAssRcrdByIpIdMap: '/icstp/crm/publiccustomers/findBeIPBadAssRcrdByIpIdMap', // 客户视图-客户信息-不良评价信息
  addProperty: '/icstp/publiccustomers/addProperty', // 客户信息-固定资产-新增/修改固定资产
  deleteproperty: '/icstp/publiccustomers/deleteproperty', // 客户信息-固定资产-删除固定资产
  findCustContactList: 'icstp/publiccustomers/findCustContactList', // 新增联系人查询客户
  findBeIPShrhInfByIpidMap: '/icstp/crm/publiccustomers/findBeIPShrhInfByIpidMap', // 客户视图-客户信息-股东信息
  selectExoStmCsRtById: '/icst/myCustomer/selectExoStmCsRtById', // 客户视图-客户信息-系统评级
  findCstCprsvCrglnList: '/icstp/cstView/findCstCprsvCrglnList', // 授信额度
  ...
  findCustInfoList: '/icstp/publiccustomers/findCustInfoList', // 客户信息-关联方信息-关联方信息选择关联方列表
  sharesList: '/icstp/cstView/sharesList', // 股金
  changeCustomer: '/icst/customerBlend/changeCustomer', // 调配
  findBeIpRscInfByIpIdMap: '/icstp/crm/publiccustomers/findBeIpRscInfByIpIdMap', // 客户视图-客户信息-固定资产信息
  hasCustomerClaimByCstId: '/icst/public/hasCustomerClaimByCstId', // vip是否审批中
 
  dealWithCstFiastTblByMonth: '/icst/customerPortrait/dealWithCstFiastTblByMonth/', // 客户金融资产趋势线形图

  findMnulLblValList: '/icstp/cstLab/findMnulLblValList'  // 自建标签查询
}
